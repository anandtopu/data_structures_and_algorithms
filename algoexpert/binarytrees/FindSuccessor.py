'''
Difficulty: Category: Binary TreesSuccessful Submissions: 27,750+Find Successor
...
Optimal Space & Time ComplexityO(h) time | O(1) space - where h is the height of the tree
'''
